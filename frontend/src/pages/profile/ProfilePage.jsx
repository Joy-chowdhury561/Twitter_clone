...
import {getMyPosts,MyLikedPosts} from "../../api/postApi.js"
		...
		<>
			<div className='flex-[4_4_0]  border-r border-gray-700 min-h-screen '>
				...
				<div className='flex flex-col'>
						...
						<>
							<div className='flex gap-10 px-4 py-2 items-center'>
								...
								<div className='flex flex-col'>
									...
									<span className='text-sm  text-slate-500'>{Myposts?.length+1} posts</span>
								</div>
							</div>

							<div className='relative group/cover'>
								<img
									src={coverImg || user?.coverImg || defaultCoverImg}
                    ...
                    <Posts posts={feedType==="posts"?Myposts:LikedPosts} isLoading={feedType==="posts"?mypostsLoding:likedPostsLoading} />
